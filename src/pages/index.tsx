...
export default function Home() {
  ...
  const fetchAllUser = api.post.getAll.useQuery();
  const fetchOneUser = api.post.getOne.useQuery({ id: userId });
  
  const userCreate = api.post.createUser.useMutation()
  const updateUser = api.post.update.useMutation()

  const deleteUser = api.post.delete.useMutation()
